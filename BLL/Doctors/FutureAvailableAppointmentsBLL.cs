...
{
    public class FutureAvailableAppointmentsBLL
    {
        FutureAvailableAppointmentsDAL faa = new FutureAvailableAppointmentsDAL();
      
        
        public List<GetFutureAvailableAppointments_Result> GetFutureAvailableAppointments(int providerID)
        {
            List<GetFutureAvailableAppointments_Result> gfaa = faa.GetFutureAvailableAppointments(providerID);

            return gfaa;
        }

        public void acceptAppointment(string patientID, string appTime, string appDate, int ProviderID, string appType, string reason)
        {
        ...
        public void SaveAppointmentAdvancedMD(XmlNode usercontext , string url,string patientID, string appTime, string appDate, int ProviderID, string appType, string reason)
        {
            ...
            ppmdappt.SetAttribute("patient", "pat" + patientID);
