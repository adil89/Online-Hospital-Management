<%@ Page Title="" Language="C#" MasterPageFile="~/Patients/Layout.Master" AutoEventWireup="true" CodeBehind="FutureAppointments2.aspx.cs" Inherits="drchrono.Doctor.FutureAppointments2" %>
    ...
    <script type="text/javascript">
        ...
        function load_MyFutureAppts() {
            ...
            $('#tblFutureAlailAppointments').jtable({
                ...
                actions: {
                    listAction: 'FutureAppointments2.aspx/GetMyFutureAppointments'
